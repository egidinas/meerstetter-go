...
Meerstetter-Go is the public protocol and utility baseline for
MeCom/Meerstetter work. It should stay independently useful and free of Loom
...
- Keep vendor/protocol-general code here: MeCom framing, object dictionaries,
  CANopen/EDS parsing, transport-neutral TM/TC, ring logging, utility server,
  graph-wall assignments, and public export interfaces.
